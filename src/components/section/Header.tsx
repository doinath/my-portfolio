...
export const Header: React.FC<HeaderProps> = ({
    ...
    return (
        ...
        <header className="relative z-10 mx-auto max-w-1xl px-6 py-1 flex items-center justify-between border-b border-white/1">
            ...
            {/* Logo Mark */}
            <div className="flex items-center gap-2 font-default text-l tracking-tight mt-3">
            ...
            <div className="hidden sm:flex items-center gap-1 rounded-full border border-white/10 bg-white/[0.02] px-4 py-1.5 backdrop-blur-md mt-3">
            ...
            {/* Origin Geolocation */}
            <div className="text-right text-xs tracking-wider text-neutral-400 mt-3">
